...
<title>项目管理系统</title>
<link href="${pageContext.request.contextPath}/style/item.css" rel="stylesheet">
...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/bg.jpg')">
		<div align="left" style="width: 80%;height:100px ;float: left;padding-top: 40px;padding-left: 30px;" ><font color="white" size="6" >项目管理系统</font></div>
		<div style="padding-top: 70px;padding-right: 20px;">当前用户：&nbsp;<font color="white" >${currentUser.userName }</font></div>
	</div>
</div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="developer?action=mySublist"><i class="icon-chevron-right"></i>我的任务</a></li>
					<li><a href="developer?action=sublist"><i class="icon-chevron-right"></i>完成记录</a></li>
					<li><a href="developer?action=preChange"><i class="icon-chevron-right"></i>修改个人信息</a></li>
					...
					<div class="span10">
						<jsp:include page="${mainPage==null?'developer/blank.jsp':mainPage}"></jsp:include>
					</div>
			</div>
		</div>
</body>
