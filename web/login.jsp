...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        <h2 class="form-signin-heading"><font color="gray">项目管理系统</font></h2>
		...
		<label class="radio inline">
			<input id="itemManager" type="radio" name="userType" value="itemManager" ${userType==2?'checked':''} /> 项目管理员
		</label>
		<label class="radio inline">
		    <input id="developer" type="radio" name="userType" value="developer" ${userType==3?'checked':''} /> 开发者
		</label>
